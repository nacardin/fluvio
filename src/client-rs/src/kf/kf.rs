...
use kf_protocol::message::fetch::*;
use kf_protocol::message::metadata::*;
use kf_protocol::message::offset::*;
use kf_protocol::message::group::*;
use kf_protocol::api::*;
use kf_protocol::message::offset::ListOffsetPartitionResponse;
use kf_protocol::message::topic::*;
...
impl KfLeader {
    ...
    async fn fetch_logs_inner(
        ...
        offset: i64,
        max_bytes: i32,
    ) -> Result<FetchablePartitionResponse<RecordSet>, KfSocketError> {
